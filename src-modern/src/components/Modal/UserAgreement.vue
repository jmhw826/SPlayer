  ...
  <div class="user-agreement">
    ...
    <n-scrollbar class="scrollbar">
      <n-flex class="date" justify="center">
        <n-tag round>生效日期：2025 年 2 月 15 日</n-tag>
        <n-tag type="warning" round>更新日期：2025 年 2 月 15 日</n-tag>
      </n-flex>
      <n-p>
        欢迎使用 云音乐（以下简称“本网站”）。本网站是一个在线音乐播放网站，可能会调用第三方 API
        来增强其功能。请在使用本网站前仔细阅读本用户协议。本协议是您（以下简称“用户”）与 云音乐
        开发团队（以下简称“开发者”）之间的法律协议。一旦您使用本网站，即表示您同意接受本协议的所有条款和条件。
      </n-p>
      <n-h3 prefix="bar"> 网站使用 </n-h3>
      <n-ol>
        <n-li>本网站是一款本地音乐播放网站，允许用户播放存储在设备上的音频文件。</n-li>
      ...
      <n-ol>
        ...
        <n-li>用户在使用、修改和分发 云音乐 时，必须遵守 AGPL-3.0 许可的条款和条件。</n-li>
        <n-li>
      ...
      <n-card ref="readOverRef">
        若你（使用者）接受以上协议，请点击下面的“同意并使用”按钮签署本协议，若不接受，请立即将网站退出并清除本网站的所有数据。
      </n-card>
    </n-scrollbar>
