<template>
    <div class="song" v-if="musicDetail">
        <div class="detail">
            <div class="pic">
                <n-image show-toolbar-tooltip class="coverImg" :previewed-img-props="{ style: { borderRadius: '8px' } }"
                    :preview-src="getCoverUrl(musicDetail?.al.picUrl)" :src="getCoverUrl(musicDetail?.al.picUrl, 1024)"
                ...
                <n-image class="shadow" preview-disabled :src="getCoverUrl(musicDetail?.al.picUrl, 1024)"
                    fallback-src="/images/pic/default.png" />
            </div>
            <div class="right">
                <div class="intr">
                    ...
                    <n-space class="tag">
                        <n-tag v-if="musicDetail.fee == 1 || musicDetail.fee == 4" class="vip" round :bordered="false">
                    ...
                    <div class="item">
                        ...
                        <n-text class="text" v-html="musicDetail.al.name"
                ...
                <n-space class="button">
                    ...
                    <n-button strong secondary v-if="musicDetail.mv"
